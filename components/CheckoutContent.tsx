...
export function CheckoutContent({ language: forcedLanguage }: { language?: Language }) {
  ...
  const copy = {
    pt: {
      ...
      lead: "Agora o pedido aceita vários itens, quantidade por produto e dados completos para contato e entrega.",
      product: "Produto",
      quantity: "Quantidade",
      ...
      paypalLead: "Checkout online com PayPal. O total é recalculado no servidor antes da captura.",
      browse: "Voltar ao catálogo",
      placeholderName: "Seu nome",
      placeholderEmail: "voce@email.com",
      placeholderPhone: "+81...",
      placeholderAddress1: "Rua, número, bairro",
      placeholderAddress2: "Apartamento, prédio, referência",
      placeholderPostalCode: "000-0000",
      placeholderCity: "Tokyo, Osaka, Kyoto...",
      placeholderNotes: "Dúvidas, horário de entrega, pedido maior...",
      shippingNote: "Estimativa preliminar por faixa de peso. A confirmação final depende da cotação real de frete internacional via Correios/operação logística."
    },
    ja: {
      eyebrow: "注文を始める",
