...
export const products: Product[] = [
...

  {
    ...
    benefits: [
      { pt: "Torrada sem adição de sal, preservando o sabor natural.", ja: "無塩ローストで自然な風味をそのままに。" },
    ...
    faq: [
      {
        question: { pt: "Tem adição de sal ou conservantes?", ja: "塩分や保存料は入っていますか?" },
...

  {
    ...
    name: { pt: "Chocolate OnVeg 70% com Açúcar de Coco – 80g", ja: "OnVeg ダークチョコレート70% ココナッツシュガー 80g" },
    shortDescription: {
    ...
    tastingNotes: {
      pt: "Cacau intenso com leve doçura de coco.",
      ja: "濃厚なカカオとほのかなヤシの甘さ。"
    },
    usage: {
...

  {
    ...
    name: { pt: "Chocolate OnVeg ao Leite de Coco 50% – 80g", ja: "OnVeg ミルクチョコレート50% ヤシミルク 80g" },
    shortDescription: {
    ...
    tastingNotes: {
      pt: "Cacau suave com toque cremoso de coco.",
      ja: "まろやかなカカオとヤシのクリーミーさ。"
    },
    usage: {
    ...
    faq: [
      {
        ...
        answer: { pt: "Nao é hidrossolúvel. Mexa bem e coe antes de consumir.", ja: "水溶性ではありません。よく混ぜてから濾してお召し上がりください。" }
      }
    ],
    priceYen: 0,
...

  {
    ...
    name: { pt: "Mel Orgânico MN Própolis – Bisnaga 200g", ja: "オーガニックハニー MN Própolis スクイズボトル 200g" },
    shortDescription: {
      pt: "Mel orgânico certificado Orgânico Brasil, em bisnaga prática de 200g.",
      ja: "オーガニックブラジル認証済み蜂蜜。使いやすい200gスクイズボトル入り。"
    },
    story: {
      pt: "O mel da MN Própolis possui certificação Orgânico Brasil por auditoria, garantindo a origem e o processo de produção. Apresentado em bisnaga higiênica para fácil uso no dia a dia.",
...

  {
    ...
    badge: { pt: "Orgânico", ja: "オーガニック" },
    tastingNotes: {
      pt: "Encorpado, com notas de caramelo e baunilha.",
      ja: "コクのある味わいにキャラメルとバニラのニュアンス。"
    },
    usage: {
...

  {
    ...
    story: {
      pt: "A PonLee produz própolis verde brasileiro desde há décadas com o selo Export Brazil. Concentração e pureza reconhecidas internacionalmente, especialmente no mercado japonês.",
...

  {
    ...
    name: { pt: "Própolis PonLee com Cúrcuma e Pólen – 30ml", ja: "プロポリス PonLee クルクマ＋花粉 ブレンド 30ml" },
    shortDescription: {
...

  {
    ...
    name: { pt: "Café Gourmet Orgânico Biodinâmico Cia. Orgânica – 250g", ja: "Cia. Orgânica バイオダイナミックコーヒー 250g" },
    shortDescription: {
    ...
    tastingNotes: {
      pt: "Arábica complexo, com corpo pleno e acidez equilibrada.",
      ja: "複雑な風味、豊かなコク、バランスのよい酸味。"
    },
    usage: {
